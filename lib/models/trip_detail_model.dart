...
TripDetailModel tripDetailModelFromJson(String str) => TripDetailModel.fromJson(json.decode(str));

String tripDetailModelToJson(TripDetailModel data) => json.encode(data.toJson());
...
class TripDetailModel {
  ...
  factory TripDetailModel.fromJson(Map<String, dynamic> json) => TripDetailModel(
        ...
        mtracForm: json["MTRACForm"] == null ? null : MtracForm.fromJson(json["MTRACForm"]),
...
class Destination {
  ...
  factory Destination.fromJson(Map<String, dynamic> json) => Destination(
        ...
        deleted: json["deleted"] == null ? false : json["deleted"],
        isAdHocDestination: json["isAdHocDestination"] == null ? false : json["isAdHocDestination"],
        status: json["status"],
        tripId: json["tripId"],
...
class Driver {
  ...
  factory Driver.fromJson(Map<String, dynamic> json) => Driver(
        ...
        adminSubUnitId: json["adminSubUnitId"] == null ? null : json["adminSubUnitId"],
...
class MtracForm {
  ...
  factory MtracForm.fromJson(Map<String, dynamic> json) => MtracForm(
        ...
        despatchDate: json["dispatchDate"] == null ? null : DateTime.parse(json["dispatchDate"]).toLocal(),
        despatchTime: json["dispatchTime"] == null ? null : DateTime.parse(json["dispatchTime"]).toLocal(),
        relaseDate: json["releaseDate"] == null ? null : DateTime.parse(json["releaseDate"]).toLocal(),
        relaseTime: json["releaseTime"] == null ? null : DateTime.parse(json["releaseTime"]).toLocal(),
        isAdditionalDetailApplicable:
            json["isAdditionalDetailApplicable"] == null ? false : json["isAdditionalDetailApplicable"],
        driverRiskAssessmentChecklist: json["driverRiskAssessmentChecklist"] == null
            ? []
            : List<String>.from(json["driverRiskAssessmentChecklist"].map((x) => x)),
        otherRiskAssessmentChecklist: json["otherRiskAssessmentChecklist"] == null
            ? []
            : List<String>.from(json["otherRiskAssessmentChecklist"].map((x) => x)),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "driverRiskAssessmentChecklist": List<dynamic>.from(driverRiskAssessmentChecklist.map((x) => x)),
        "otherRiskAssessmentChecklist": List<dynamic>.from(otherRiskAssessmentChecklist.map((x) => x)),
...
class Vehicle {
  ...
  factory Vehicle.fromJson(Map<String, dynamic> json) => Vehicle(
        ...
        model: json["model"],
        isServiceable: json["isServiceable"] == null ? false : json["isServiceable"],
        deleted: json["deleted"] == null ? false : json["deleted"],
